...
<ul><li><strong>Le paiement échelonné</strong> : nos formules sont payables en plusieurs fois sans frais, ce qui étale la dépense sur plusieurs mois de budget étudiant.</li><li><strong>Le CPF</strong> : si vous êtes en alternance, en apprentissage, ou si vous avez déjà travaillé, vous avez peut-être des droits cumulés. Notre école étant certifiée Qualiopi, les formations éligibles peuvent être financées ainsi — voir <a href="/blog/financement-cpf-compte-permis">notre guide du financement CPF</a>.</li><li><strong>Le permis à 1 euro par jour</strong> : ce dispositif d'État s'adresse aux 15-25 ans sous la forme d'un prêt à taux zéro. Contactez-nous pour vérifier l'éligibilité de votre formule.</li><li><strong>Les aides locales</strong> : mairies, missions locales et certains dispositifs régionaux proposent des coups de pouce. Un passage au CROUS ou au service vie étudiante vaut souvent le détour.</li></ul>
...
<p>Chez nous, à partir de <strong>899 €</strong> pour le forfait 20h en boîte manuelle et <strong>799 €</strong> pour le forfait 13h en boîte automatique. CPF accepté (nous sommes certifiés Qualiopi), paiement en plusieurs fois sans frais. Le détail complet, y compris les frais annexes à surveiller, est dans notre article <a href="/blog/prix-permis-conduire-nanterre">combien coûte le permis à Nanterre</a>, et la grille est sur la <a href="/tarifs">page tarifs</a>.</p>
...
<ul><li>Le prix affiché inclut-il les frais de présentation à l'examen et le véhicule le jour J ?</li><li>Que se passe-t-il en cas d'échec : les heures supplémentaires sont-elles à tarif normal ?</li><li>Quel est le délai moyen pour obtenir une place d'examen pratique ?</li><li>L'auto-école est-elle certifiée Qualiopi (condition indispensable pour un financement CPF) ?</li></ul>
